...
namespace CoolerEpicLootChests
{
    public class Utilities
    {
        ...
        {
            var resource = typeof(CoolerEpicLootChests).Assembly.GetManifestResourceNames().Single
                (s => s.EndsWith(bundleName));
            using var stream = typeof(CoolerEpicLootChests).Assembly.GetManifestResourceStream(resource);
